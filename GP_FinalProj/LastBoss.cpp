...
LastBoss::LastBoss() : Map("../../Resource/Map/LastBoss.png", 1), showBossIntro(true), bossIntroTotalTimer(4.0f), currentFrame(0), frameDuration(1.0f), frameTimer(0.0f), bossMonster(nullptr) {
    SpawnMonsters();
